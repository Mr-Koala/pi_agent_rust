...
> Generated: 2026-09-07T13:12:11Z
> Git ref: 8cd59fec
> CI run: 34125497544
...
| Must-pass gate event log | PASS | 1 | 53772 B | `tests/ext_conformance/reports/gate/must_pass_events.jsonl` |
| Per-extension failure dossiers | MISS | 0 | 0 B | `tests/ext_conformance/reports/dossiers` |
| Health & regression delta report | PASS | 3 | 80521 B | `tests/ext_conformance/reports/health_delta` |
...
| Extension journey report | PASS | 1 | 1184 B | `tests/ext_conformance/reports/journeys/journey_report.json` |
...
| PERF-3X stress triage report | PASS | 1 | 4792 B | `tests/perf/reports/stress_triage.json` |
...
| Section | Status | Files | Size | Path |
|---------|--------|-------|------|------|
| Requirement-to-test traceability matrix | PASS | 1 | 94685 B | `docs/traceability_matrix.json` |
...
- **PERF-3X lineage coherence contract** (invalid): PERF-3X lineage span exceeds 14 days for run_id '34125497544' (oldest=2026-05-12 19:26:24 UTC, newest=2026-09-07 13:12:10 UTC)
